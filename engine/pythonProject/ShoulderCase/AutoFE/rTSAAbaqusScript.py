...
def rTSAWithAbaqus(inputPath):
    ...
    mdb.models['Model-1'].ConcentratedForce(
        cf1=loadDirection[0] * (-loadMag),
        cf2=loadDirection[1] * (-loadMag),
        cf3=loadDirection[2] * (-loadMag),
    ...
    mdb.models['implant'].parts['PART-1'].Set(
        name='implantNodes',
        nodes=mdb.models['implant'].parts['PART-1'].nodes,
    )
    ...
    mdb.models['Model-1'].Tie(
        adjust=OFF,
        main=mdb.models['Model-1'].rootAssembly.instances['implant.PART-1-1'].sets['implantNodes'],
        name='tie',
        positionToleranceMethod=COMPUTED,
        secondary=mdb.models['Model-1'].rootAssembly.instances['scapula.PART-1-1'].sets['scapulaNodes'],
        thickness=ON,
        tieRotations=ON
    )
